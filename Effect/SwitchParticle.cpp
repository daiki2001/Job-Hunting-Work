#include "SwitchParticle.h"
#include "./Header/DrawPolygon.h"
#include "./Header/Parameter.h"

const int SwitchParticle::MAX_TIME = 10;
int SwitchParticle::model = FUNCTION_ERROR;
...
void SwitchParticle::Init()
{
	model = Library::DrawPolygon::GetInstance()->CreateSphere(0.1f, 6);
}

void SwitchParticle::Create(const Vector3& startPos)
{
...
void SwitchParticle::Draw(const Vector3& offset)
{
